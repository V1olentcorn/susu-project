...
<template>
  <div class="flex flex-col gap-2 w-full min-h-96">
    <div class="w-full border mt-4 rounded-lg p-4 flex items-center justify-center h-96 relative">
...
import type { VariantType } from "../Imagetrail/ImageTrailCursor.vue";
import {
  Select,
  SelectTrigger,
  SelectValue,
